...
- **展开区域**: 从左边界到 (right - 62)px
- **开关区域**: 最右侧 46x18px,距右边缘8px
...
- **尺寸**: 46x18像素, 扁平矩形设计
- **关闭状态**: 灰色轨道(RGB 173,173,173), 黑色矩形滑块(12x20px)在左侧
- **开启状态**: 蓝色轨道(RGB 0,120,215), 黑色矩形滑块在右侧
- **悬停关闭**: 轨道变为RGB(203,203,203)
- **悬停开启**: 轨道变为RGB(56,165,250)
- **边框**: 2px灰色边框(RGB 173,173,173)
- **切换**: 即时切换,无动画
...
2. **双缓冲绘制**: 避免闪烁
3. **Win8风格复用**: 复用`SwitchPaintWin8`的样式,保持UI一致性
